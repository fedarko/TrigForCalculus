...
public class MainActivity extends Activity {
	...
	public void goToTrigDerivativesScreen(View view) {
    	Intent i = new Intent(getApplicationContext(), RegularDerivativesActivity.class);
    	startActivity(i);
	}
	
	public void goToTrigIntegralsScreen(View view) {
		Intent i = new Intent(getApplicationContext(), RegularIntegralsActivity.class);
		startActivity(i);
	}
	
	public void goToArctrigDerivativesScreen(View view) {
		Intent i = new Intent(getApplicationContext(), ArctrigDerivativesActivity.class);
		startActivity(i);		
	}
	
	public void goToArctrigIntegralsScreen(View view) {
		Intent i = new Intent(getApplicationContext(), ArctrigIntegralsActivity.class);
		startActivity(i);		
	}
}
